                                ...
                                <div class="card-body">
                                    ...
                                    <form action="<?php echo site_url('admin/produk/tambah') ?>" method="post" enctype="multipart/form-data" >
                                        ...
                                        <div class="form-group">
                                            ...
                                            type="text" name="nama" placeholder="Nama Produk" value="<?php echo set_value('nama'); ?>"/>
                                            <div class="invalid-feedback">
                                        ...
                                        <div class="form-group form-row">
                                            <div class="col">
                                                ...
                                                type="number" min="1" name="hargabeli" value="<?php echo set_value('hargabeli'); ?>"/>
                                                <div class="invalid-feedback">
                                            ...
                                            <div class="col">
                                                ...
                                                type="number" min="1" name="harga" value="<?php echo set_value('harga'); ?>"/>
                                                <div class="invalid-feedback">
                                        ...
                                        <div class="form-group form-row">
                                            <div class="col">
                                                ...
                                                type="text" name="satuan" value="<?php echo set_value('satuan'); ?>"/>
                                                <div class="invalid-feedback">
                                            ...
                                            <div class="col">
                                                ...
                                                type="number" min="1" name="stok" value="<?php echo set_value('stok'); ?>"/>
                                                <div class="invalid-feedback">
                                            ...
                                            <div class="col">
                                                ...
                                                type="number" min="0" name="stokmin" value="<?php echo set_value('stokmin'); ?>"/>
                                                <div class="invalid-feedback">
                                        ...
                                        <div class="form-group">
                                            ...
                                            type="number" name="deskripsi" placeholder="Deskripsi Produk" rows="3"><?php echo set_value('deskripsi'); ?></textarea>
                                            <div class="invalid-feedback">
                                                <?php echo form_error('harga') ?>
                                            </div>
                                        </div>
