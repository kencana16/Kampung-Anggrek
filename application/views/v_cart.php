            ...
            <div class="col-md-8">
                ...
                <div class="row">
                    <?php foreach ($data as $row) : ?>
                        <div class="col-md-4">
                            <div class="thumbnail">
                                <img width="200px" src="<?php echo base_url().'assets/images/'.$row->produk_image; ?> " alt=" <?php echo $row->produk_nama; ?>">
                                <div class="caption">
                                    <h4> <?php echo $row->produk_nama; ?> </h4>
                                    <div class="row">
                                        <div class="col-md-7"><h4><?php echo 'Rp.'.number_format($row->produk_harga); ?></h4></div>
                                        <div class="col-md-5"><input type="number" name="quantity" id="<?php echo $row->produk_id;?>" value="1" class="quantity form-control"></div>
                                    </div>
