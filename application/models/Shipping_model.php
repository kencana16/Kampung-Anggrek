...
class Shipping_model extends CI_Model{
    ...
    public function getOngkir($destinationCity,$courier){
        ...
        for ($i=0; $i < count($data['rajaongkir']['results'][0]['costs']); $i++) {
            // echo "<option value='".$data['rajaongkir']['results'][0]['costs'][$i]['cost'][0]['value']."'>"
            //     .strtoupper($data['rajaongkir']['results'][0]['code'])."-"
            //     .$data['rajaongkir']['results'][0]['costs'][$i]['service']."  Rp. "
            //     .number_format($data['rajaongkir']['results'][0]['costs'][$i]['cost'][0]['value'])." ("
            //     .$data['rajaongkir']['results'][0]['costs'][$i]['cost'][0]['etd']." ";
